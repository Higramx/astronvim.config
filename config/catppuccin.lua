    ...
    require("catppuccin").setup {
        ...
        custom_highlights = function(colors)
            return {
                ...
                MatchParen = { fg = colors.mauve },
                Comment = { fg = colors.green },
                NormalFloat = { bg = "none" },
                --Normal = { bg = colors.crust },
                FloatBorder = { bg = "none", fg = colors.mauve },
                WinSeparator = { bg = "none" --[[ colors.base ]], fg = colors.surface0 },
                CursorLineNr = { fg = colors.mauve, style = { "bold" } },
                LineNr = { fg = colors.surface2 },
                Pmenu = { bg = "none" --[[ colors.crust ]], fg = "" },
                PmenuSel = { bg = "none" --[[ colors.surface0 ]], fg = "" },
                ...
                TelescopeResultsBorder = { bg = "none", fg = colors.text },
                TelescopePreviewBorder = { bg = "none", fg = colors.text },
                TelescopePromptTitle = { fg = "", bg = "" },
